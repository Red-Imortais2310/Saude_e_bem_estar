...
const materiasData = {
    ...
    // MATÉRIA 1 CORRIGIDA: SAÚDE MENTAL
    'saude_mental': { 
    ...
    // MATÉRIA 2 CORRIGIDA: NUTRIÇÃO DO FUTURO
    'nutricao': { 
    ...
    // MATÉRIA 3 CORRIGIDA: FITNESS E I.A.
    'fitness_ia': { 
    ...
    // --- MATÉRIAS SECUNDÁRIAS E EXTERNAS (Mantidas - Abrem link diretamente ou pop-up) ---
    // Links Externos (Usam data-materia no HTML, mas abrem link)
    ...
    'ineficiencia_eua': { linkExterno: 'https://institutosaudeindependente.com/relatorio-eficacia-refoco-curta-2025' },
    'ineficiencia_europa': { linkExterno: 'https://ministeriosaudealemanha.gov/revisao-protocolos-reicencao-idosos' },
    'ineficiencia_asia': { linkExterno: 'https://portalnoticiasasia.com/investigacao-falha-logistica-vacinas-china' },
